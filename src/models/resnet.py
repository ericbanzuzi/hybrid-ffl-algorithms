...
class ResNet18(nn.Module):
    def __init__(
        ...
        if BN_to_GN:
            # Replace BatchNorm2d layers with GroupNorm
        ...
        if BN_to_GN:
            ...
            for name, module in self.net._modules.items():
                if isinstance(module, nn.BatchNorm2d):
                    ...
                    group_norm = nn.GroupNorm(num_groups=32, num_channels=num_channels)
                    # Update the module in the model
                    self.net._modules[name] = group_norm
...
if __name__ == "__main__":
    ...
    print("\nTorchResNet18:")
    model = TorchResNet18(num_classes=10, dataset="cifar10")
    summary(model, input_size=(1, 3, 32, 32))
